...
class FieldValidator {
    ...
    maxLength(value = this.field.getValue(), report = true) {
        ...
        if (!valid && report) {
            this.setError(this.field.i18n('errMaxLength', { maxLength }));
        }
        return valid;
    }
    ...
    minLength(value = this.field.getValue(), report = true) {
        ...
        if (!valid && report) {
            this.setError(this.field.i18n('errMinLength', { minLength }));
        }
        return valid;
    }
    ...
    length(value = this.field.getValue()) {
        ...
        if (!valid) {
            this.setError(this.field.i18n('errLength', { length }));
        }
        return valid;
    }
    ...
    size(value = this.field.getValue()) {
        ...
        if (!valid) {
            this.setError(this.field.i18n('errSize', { size }));
        }
        return valid;
    }
